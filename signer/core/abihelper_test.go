...
import (
	...
	"github.com/8thlight/go-ethereum/accounts/abi"
...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/8thlight/wiki/wiki/Ethereum-Contract-ABI#examples
...
[
	...
	for _, hexdata := range []string{
		...
		// From https://github.com/8thlight/wiki/wiki/Ethereum-Contract-ABI
